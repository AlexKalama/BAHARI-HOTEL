...
export async function sendBookingConfirmationEmail(data: BookingSummaryEmailData): Promise<boolean> {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL_FROM || 'Bahari Hotel <reservations@baharihotel.com>',
      to: data.guestEmail,
      subject: `Booking Confirmation - Bahari Hotel #${data.bookingId.substring(0, 8)}`,
      html: emailContent,
    };
...
export async function sendPaymentReceiptEmail(data: BookingSummaryEmailData): Promise<boolean> {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL_FROM || 'Bahari Hotel <payments@baharihotel.com>',
      to: data.guestEmail,
      subject: `Payment Receipt - Bahari Hotel #${data.bookingId.substring(0, 8)}`,
      html: emailContent,
    };
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Your reservation at Bahari Hotel has been confirmed. Please find your booking details below:</p>
        ...
        <div class="footer">
          ...
          <p>&copy; ${new Date().getFullYear()} Bahari Hotel. All rights reserved.</p>
        </div>
      </div>
    </body>
    </html>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Thank you for choosing Bahari Hotel. We look forward to welcoming you!</p>
